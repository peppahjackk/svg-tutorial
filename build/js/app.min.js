...
var _animConfig = require('animConfig.json');

var _animConfig2 = _interopRequireDefault(_animConfig);
...
var Icon = function () {
  ...
  _createClass(Icon, [{
    ...
    key: 'handleAnimState',
    value: async function handleAnimState(callback) {
    ...
    key: 'circleAnimInit',
    value: function circleAnimInit() {
      var _this = this;

      var deg = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '360';
      ...
      this.animation = (0, _animejs2.default)({
        ...
        duration: _animConfig2.default.duration,
    ...
    key: 'circleAnimTrigger',
    value: function circleAnimTrigger() {
    ...
    key: 'pinAnim',
    value: function pinAnim(e) {
      var _this2 = this;

      this.handleAnimState().then(function (cancelAnim) {
        if (cancelAnim) return;
    ...
    key: 'initNurseAnim',
    value: function initNurseAnim(e) {
      var _this3 = this;

      this.nurseAnim = _animejs2.default.timeline({
        easing: 'easeOutQuad',
        complete: function complete() {
          _this3.animating = false;
          _this3.animated = true;
        }
      }).add({
        easing: 'linear',
        targets: this.elPath,
    ...
    key: 'nurseAnimTrigger',
    value: function nurseAnimTrigger(e) {
      var _this4 = this;
    ...
    value: function monitorAnim() {
      ...
      if (this.el.classList.contains('reveal')) {
        ...
        window.setTimeout(function () {
          _this5.el.classList.remove('reveal', 'hide');
          _this5.el.classList.add('reveal');
          _this5.animPulseLine();
        }, 550);
      } else {
...
var CircleIcon = function (_Icon) {
  _inherits(CircleIcon, _Icon);

  function CircleIcon(el) {
    _classCallCheck(this, CircleIcon);

    var _this7 = _possibleConstructorReturn(this, (CircleIcon.__proto__ || Object.getPrototypeOf(CircleIcon)).call(this, el));
...
},{"animConfig.json":3,"animejs":1,"gsap":2}],5:[function(require,module,exports){
'use strict';
...
for (var i = 0; i < icons.length; i++) {
  new _icon2.default(icons[i]);
}

},{"animejs":1,"icon":4,"nav":6}],6:[function(require,module,exports){
'use strict';
...
var Nav = function () {
  ...
  _createClass(Nav, [{
    ...
    value: function init() {
      ...
      this.mob_menu_btn.addEventListener('click', function () {
        _this.toggleMobMenu();
      });
    }
  }, {
    key: 'toggleMobMenu',
    value: function toggleMobMenu() {
      var _this2 = this;
      ...
      if (this.mob_menu_active) {
        ...
        this.closeMobMenu(function () {
          ...
          _this2.mob_menu_animating = false;
        });
      } else {
    ...
    key: 'animateHamburgerOpen',
    value: function animateHamburgerOpen() {
      (0, _animejs2.default)({
        targets: this.mob_menu_icon[0],
        duration: _animConfig2.default.durationShort,
        // translateX: '3px',
        // translateY: '8px',
        rotate: '45deg',
        easing: 'easeOutExpo'
    ...
    key: 'animateHamburgerClosed',
    value: function animateHamburgerClosed() {
      (0, _animejs2.default)({
        targets: this.mob_menu_icon[0],
        duration: _animConfig2.default.durationShort,
        rotate: '0deg',
    ...
    key: 'openMobMenu',
    value: function openMobMenu(callback) {

      callback();
    }
  }, {
    key: 'closeMobMenu',
    value: function closeMobMenu(callback) {
...
},{"animConfig.json":3,"animejs":1,"gsap":2}]},{},[5])
